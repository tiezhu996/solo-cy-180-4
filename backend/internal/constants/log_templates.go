...
const (
	...
	LogOutlineDraftCreate  = "outline draft create by=%s project=%d version=%d source=%d"
	LogOutlineQuestionSave = "outline question save by=%s project=%d version=%d question=%d"
	LogOutlineQuestionDel  = "outline question delete by=%s project=%d version=%d question=%d"
	LogOutlineSubmit       = "outline submit by=%s project=%d version=%d from=%s"
	LogOutlineApprove      = "outline approve by=%s project=%d version=%d reviewer=%s"
	LogOutlineReject       = "outline reject by=%s project=%d version=%d reviewer=%s reason=%s"
