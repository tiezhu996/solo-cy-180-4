...
const (
	...
	MsgOutlineDraftSaved     = "提纲草稿已保存"
	MsgOutlineSubmitted      = "提纲已提交，等待档案员或管理员审核"
	MsgOutlineApproved       = "提纲审核通过，版本已锁定"
	MsgOutlineRejected       = "提纲已退回采访员"
	MsgOutlineVersionCreated = "已基于历史版本创建新草稿版本"
